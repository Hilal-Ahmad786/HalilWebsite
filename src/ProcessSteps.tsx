...
export default function ProcessSteps() {
  ...
  stepNumber: "absolute -top-4 -left-4 w-16 h-16 bg-lime-400 text-gray-900 flex items-center justify-center text-3xl font-black z-10 border-4 border-gray-900",
