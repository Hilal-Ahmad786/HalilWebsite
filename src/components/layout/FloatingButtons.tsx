          ...
          >
            ...
            <div className="relative">
              <button
                ...
                className="relative w-16 h-16 bg-[#25D366] text-white flex items-center justify-center text-3xl shadow-2xl border-4 border-white hover:scale-110 hover:rotate-6"
                aria-label="WhatsApp"
              >
                ...
                {showTooltip === 'whatsapp' && (
                  <div className="absolute right-full mr-3 bg-gray-900 text-white px-4 py-3 whitespace-nowrap font-bold tracking-wide fade-in">
                    ...
                    <div className="text-xs text-[#25D366]">Hemen Mesaj Gönder</div>
                ...
                <div className="absolute right-full mr-3 bottom-0 w-64 bg-white shadow-2xl border border-gray-200 fade-in">
                  ...
                  <div className="px-3 py-3 bg-gray-50">
                    ...
                    <button
                      ...
                      className="w-full mt-2 bg-[#25D366] text-white px-3 py-2 font-bold text-xs hover:bg-[#20bd5a] transition flex items-center justify-center gap-1"
                    >
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-gray-900 border-t-4 border-lime-400 shadow-2xl">
        <div className="flex items-stretch">
          ...
          <button
            ...
            className="flex-1 flex flex-col items-center justify-center py-4 px-4 bg-[#25D366] text-white hover:bg-[#20bd5a] transition active:scale-95"
          >
