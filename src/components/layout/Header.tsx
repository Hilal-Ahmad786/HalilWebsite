        ...
        <div className="flex items-center justify-between h-20">
              ...
              <div className="absolute top-full left-0 mt-2 w-64 bg-white shadow-2xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300">
                {siteConfig.services.map((service) => (
                  <Link
                    key={service.id}
                    href={`/${service.slug}`}
                    className="block px-6 py-4 hover:bg-gray-50 border-l-4 border-transparent hover:border-purple-600 transition"
                  >
          ...
          <div className="hidden lg:flex items-center gap-3">
            ...
            <a
              ...
              className="bg-[#25D366] text-white px-5 py-3 font-bold text-sm tracking-wide hover:bg-[#20bd5a] transition flex items-center gap-2 rounded-md shadow-md hover:shadow-lg"
            >
            ...
            <a
              ...
              className="bg-lime-400 text-gray-900 px-6 py-3 font-black text-sm tracking-wider hover:bg-lime-300 transition flex items-center gap-2 shadow-lg hover:shadow-xl transform hover:scale-105"
            >
