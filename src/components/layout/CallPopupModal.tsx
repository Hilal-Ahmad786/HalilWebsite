  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center px-4 py-6 pointer-events-none">
        <div
          className="bg-white max-w-md w-full rounded-2xl shadow-2xl pointer-events-auto animate-slideUp max-h-[95vh] flex flex-col"
          onClick={(e) => e.stopPropagation()}
        >
          {/* Header with Customer Service Agent */}
          <div className="relative bg-gradient-to-r from-purple-600 to-fuchsia-600 text-white px-5 py-4 text-center rounded-t-2xl">
            {/* Close Button */}
            <button
              onClick={handleClose}
            ...
            {/* Agent Avatar */}
            <div className="w-25 h-25 mx-auto mb-3 bg-white/20 backdrop-blur-sm flex items-center justify-center text-4xl border-4 border-white/40 rounded-full">
              👨‍💼
            </div>

            <h2 className="text-md md:text-xl font-black mb-1">
              HOŞGELDİNİZ!
            </h2>
            <p className="text-xs opacity-90">
              Müşteri temsilcimiz hemen yanıtlamaya hazır
            </p>
          </div>
          ...
          <div className="p-5 space-y-4 flex-1 flex flex-col overflow-y-auto">
            ...
            {/* CTA Buttons – ÜSTE ÇEKİLDİ */}
            <div className="space-y-3">
              {/* Phone Button - PRIMARY */}
              <button
                onClick={handlePhoneClick}
                className="w-full bg-lime-400 text-gray-900 px-6 py-3 font-black text-lg hover:bg-lime-300 transition flex items-center justify-center gap-3 shadow-lg transform hover:scale-105"
              >
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" />
                </svg>
                <div className="text-left">
                  <div className="text-[11px] opacity-80 text-sm sm:text-base">{siteConfig.phoneDisplay}  Hemen Ara</div>
                </div>
              </button>
              ...
              <button
                ...
                className="w-full bg-whatsapp text-white px-6 py-3 font-bold text-lg hover:bg-opacity-90 transition flex items-center justify-center gap-3"
              >
          ...
          {/* Footer */}
          <div className="bg-gray-50 px-5 py-3 text-center border-t border-gray-200 rounded-b-2xl">
