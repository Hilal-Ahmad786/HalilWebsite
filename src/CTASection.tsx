        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-8">
            ...
            <button
              ...
              className={`group relative px-12 py-6 font-black text-2xl tracking-wider transition-all duration-300 flex items-center gap-4 overflow-hidden shadow-2xl transform hover:scale-105 ${
                variant === 'lime'
  ...
  <path d="M22 16.9v3a2 2 0 0 1-2.2 2
           ...
           c.9.3 1.7.5 2.6.7A2 2 0 0 1 22 16.9z" />
            ...
            <button
              ...
              className={`group relative px-12 py-6 font-black text-2xl tracking-wider transition-all duration-300 flex items-center gap-4 border-4 ${
                variant === 'lime'
