    ...
    >
      ...
      <div className="bg-gray-900 border-b border-gray-800">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-[auto_1fr_auto] items-center h-16 gap-4 md:gap-6 xl:gap-8">
            {/* Left: Logo */}
            ...
            <div className="lg:hidden pb-6 pt-4 border-t border-gray-700">
              <nav className="flex flex-col space-y-4">
                ...
                <div className="space-y-2">
                  <div className="text-lime-400 font-bold text-xs tracking-wider uppercase mb-2">HİZMETLER</div>
                  {siteConfig.services.map((s) => (
                    <Link
                      key={s.id}
                      href={`/${s.slug}`}
                ...
                <div className="space-y-2">
                  <div className="text-lime-400 font-bold text-xs tracking-wider uppercase mb-2">ŞEHİRLER</div>
                ...
                <div className="flex flex-col gap-3 pt-4">
                  <a
                    ...
                    className="bg-whatsapp text-white px-6 py-3 font-bold text-center hover:bg-opacity-90 transition flex items-center justify-center gap-2 text-sm rounded-md"
                  >
