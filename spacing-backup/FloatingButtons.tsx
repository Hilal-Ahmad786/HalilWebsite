      ...
      <div className="hidden md:block">
        ...
        {isChatOpen && (
          <div className="fixed bottom-[180px] right-6 w-80 bg-white shadow-2xl border-2 border-gray-200 z-50 animate-fadeIn">
            {/* Header */}
            <div className="bg-gradient-to-r from-purple-600 to-fuchsia-600 text-white p-sm flex items-center justify-between">
            ...
            {/* Content */}
            <div className="p-sm bg-gray-50 max-h-96 overflow-y-auto">
              <p className="text-sm text-gray-700 mb-sm font-medium">
              ...
              <div className="space-y-xs">
                {quickMessages.map((msg) => (
                  <button
                    ...
                    className="w-full text-left p-3 bg-white hover:bg-purple-50 border border-gray-200 hover:border-purple-300 transition flex items-center gap-sm group"
                  >
            ...
            {/* Footer */}
            <div className="bg-gray-100 px-sm py-xs text-center">
        ...
        >
          ...
          {showTooltip === 'phone' && (
            <div className="absolute right-full mr-4 bg-gray-900 text-white py-4 whitespace-nowrap font-bold tracking-wide animate-fade-in">
