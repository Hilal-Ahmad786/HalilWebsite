    ...
    <section className="py-section-y bg-white">
      <div className="container mx-auto">
        <div className="text-center mb-xl">
          <div className="inline-block bg-lime-400/20 text-lime-600 py-3 mb-md border-2 border-lime-400">
        ...
        <div className="grid md:grid-cols-3 gap-md">
          {testimonials.map((testimonial, index) => (
            <div
              key={index}
              className="bg-gray-50 p-card border-l-4 border-purple-600 relative"
            >
              {/* Quote Icon */}
              <div className="absolute top-sm right-4 text-6xl text-gray-200 font-black">
                "
              </div>
              ...
              {/* Text */}
              <p className="text-gray-700 mb-md leading-relaxed font-medium">
                {testimonial.text}
              </p>
