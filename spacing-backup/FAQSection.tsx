...
const FAQSectionSpacing = {
  section: "py-section-y bg-gray-50",
  container: "container mx-auto max-w-4xl",
  
  // Header
  headerWrapper: "text-center mb-xl",
  badge: "inline-block bg-fuchsia-600/20 text-fuchsia-600 px-md py-sm mb-lg border-2 border-fuchsia-600",
  title: "text-5xl font-black text-gray-900 mb-md",
  
  // FAQ items
  faqContainer: "space-y-sm",
  faqItem: "bg-white border-l-4 border-purple-600 shadow-md overflow-hidden",
  faqButton: "w-full text-left p-md font-bold text-gray-900 flex items-center justify-between hover:bg-gray-50 transition",
  faqAnswer: "p-md pt-0 text-gray-700 leading-relaxed",
};
    ...
    <section className="py-section-y bg-gray-50">
      <div className="container mx-auto max-w-4xl">
        <div className="text-center mb-xl">
          <div className="inline-block bg-fuchsia-600/20 text-fuchsia-600 py-3 mb-md border-2 border-fuchsia-600">
          ...
          {faqs.map((faq, index) => (
            ...
            >
              <button
                ...
                className="w-full text-left p-md font-bold text-gray-900 flex items-center justify-between hover:bg-gray-50 transition"
              >
              ...
              {openIndex === index && (
                <div className="p-md pt-0 text-gray-700 leading-relaxed">
                  {faq.answer}
                </div>
              )}
            </div>
